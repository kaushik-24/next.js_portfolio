...
const getUniforms = () => {
  ...
  // Iterate over all the uniform entries
  ...
  // Add default uniforms for time and resolution
  preparedUniforms["u_time"] = { value: 0, type: "1f" };

  // Cast u_resolution to a THREE.Vector2 to avoid the error
  preparedUniforms["u_resolution"] = {
    value: new THREE.Vector2(size.width * 2, size.height * 2), 
    type: "2f",  // Ensure it's treated as a uniform2f
  };
